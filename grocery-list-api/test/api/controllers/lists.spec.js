...
describe('lists controller', () => {
  ...
  describe('createList', () => {
    it('should create a new list', () => {
      req = { groceryLists: { insert: jest.fn(), count: jest.fn().mockReturnValue(0) } }
  ...
  describe('retrieveList', () => {
    it('should retrieve a list', () => {
      req = { groceryLists: { get: jest.fn().mockResolvedValue({id: 1, items: [] }) }, swagger: { params: { id: { value: 1 } } } }
      res = { status: jest.fn(), send: jest.fn() }
  ...
  describe('addItemToList', () => {
    it('should add an item to a list', () => {
      req = { groceryLists: { findAndUpdate: jest.fn() }, swagger: { params: { id: { value: 1 } } } }
      res = { status: jest.fn(), end: jest.fn() }
